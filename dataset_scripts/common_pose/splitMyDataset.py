...
def split_dataset(annotation_file, train_percentage, output_dir):
    ...
    train_file = os.path.join(output_dir, 'myDataset_train.txt')
    test_file = os.path.join(output_dir, 'myDataset_test.txt')
...
if __name__ == "__main__":
    ANNOTATIONS_FILE = 'c:/Users/filip/Desktop/Politecnico/INGEGNERIA/TESI_loc/Sabater/Domain-and-View-point-Agnostic-Hand-Action-Recognition/dataset_scripts/myDataset/tot_annotations.txt'
